"""Semantic retrieval over the GitLab projects index.
        ...
        hydrated.append(
            {
                ...
                "payload": payload,
                "entity": store.fetch_project(str(project_id)),
            },
        )
    return hydrated
...
def project_semantic_search(
    *,
    ...
    """Search GitLab projects semantically in the given Qdrant collection."""
    return asyncio.run(
        _async_search(
            config=config,
