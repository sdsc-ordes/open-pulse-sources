"""Adapter wrapping `open_pulse_sources.index.gitlab_ethz_projects` for federated search/lookup."""
...
class GitLabEthzProjectsAdapter:
    ...
    def search(
        ...
        *,
        ...
        try:
            from open_pulse_sources.index.gitlab_ethz_projects.retrieval import search  # noqa: PLC0415
    ...
    def lookup(self, identifier: str) -> list[EntityRecord]:  # noqa: PLR0911
        ...
        if host != "gitlab.ethz.ch":
            return []
        try:
            from open_pulse_sources.index.gitlab_ethz_projects.store import open_store  # noqa: PLC0415
        except Exception:  # noqa: BLE001
            return []
        store = None
        try:
