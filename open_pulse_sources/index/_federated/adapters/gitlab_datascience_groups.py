...
class GitLabDatascienceGroupsAdapter:
    ...
    def search(
        ...
        *,
        ...
        try:
            from open_pulse_sources.index.gitlab_datascience_groups.retrieval import search  # noqa: I001
        except Exception:
            return []
        try:
    ...
    def lookup(self, identifier: str) -> list[EntityRecord]:
        ...
        if host != "gitlab.datascience.ch":
            return []
        try:
            from open_pulse_sources.index.gitlab_datascience_groups.store import open_store  # noqa: I001
        except Exception:
            return []
        store = None
        try:
