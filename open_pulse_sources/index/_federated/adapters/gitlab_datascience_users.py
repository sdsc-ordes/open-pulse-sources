...
class GitLabDatascienceUsersAdapter:
    ...
    def search(
        ...
        *,
        ...
        try:
            from open_pulse_sources.index.gitlab_datascience_users.retrieval import search  # noqa: I001
        except Exception:
            return []
        try:
    ...
    def lookup(self, identifier: str) -> list[EntityRecord]:
        ...
        try:
            from open_pulse_sources.common.canonicalization.gitlab import parse_gitlab_iri  # noqa: I001
        except Exception:
            return []
        ...
        if kind != "user" or host != "gitlab.datascience.ch":
            return []
        try:
            from open_pulse_sources.index.gitlab_datascience_users.store import open_store  # noqa: I001
        except Exception:
            return []
        store = None
        try:
