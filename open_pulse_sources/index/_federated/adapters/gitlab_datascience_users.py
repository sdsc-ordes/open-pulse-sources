"""Adapter wrapping `open_pulse_sources.index.gitlab_datascience_users` for federated search/lookup."""
...
class GitLabDatascienceUsersAdapter:
    name = "gitlab_datascience_users"
    entity_types: list[str] = ["user"]  # noqa: RUF012

    # Manifest hints (see IndexAdapter docstring).
    backend = "vector"
    surface_as_source = True
    id_shape = "url"  # user_id is already the canonical https://gitlab.datascience.ch/<username> URL
    ...
    def search(
        ...
        *,
        ...
        try:
            from open_pulse_sources.index.gitlab_datascience_users.retrieval import search  # noqa: PLC0415, I001
    ...
    def lookup(self, identifier: str) -> list[EntityRecord]:  # noqa: PLR0911
        ...
        try:
            from open_pulse_sources.common.canonicalization.gitlab import parse_gitlab_iri  # noqa: PLC0415, I001
        except Exception:  # noqa: BLE001
            return []
        ...
        if kind != "user" or host != "gitlab.datascience.ch":
            return []
        try:
            from open_pulse_sources.index.gitlab_datascience_users.store import open_store  # noqa: PLC0415, I001
        except Exception:  # noqa: BLE001
            return []
        store = None
        try:
...
register(GitLabDatascienceUsersAdapter())
